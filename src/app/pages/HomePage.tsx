...
// Hero carousel slides: pick the heroFeatured ones
...
export function HomePage() {
  ...
  const feedArticles = useMemo(() => {
    ...
    const matchedCategories = categoryMatchMap[activeFeedCategory] ?? [];
    return articles.filter((a) => matchedCategories.includes(a.category));
  }, [activeFeedCategory]);
    ...
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Link
              to={`/articulo/${featuredRecent.slug}`}
              className="block group"
              style={{ textDecoration: "none" }}
            >
              <div
                className="relative overflow-hidden rounded"
                style={{ aspectRatio: "16/9", background: "#0b0b0b" }}
              >
                <img
                  src={featuredRecent.image}
          ...
          <div className="flex flex-col gap-4">
              ...
              >
                <article className="flex gap-3 pb-4" style={{ borderBottom: "1px solid #f0f0f0" }}>
                  <div
                    ...
                    style={{ width: "80px", height: "64px", background: "#111" }}
                  >
                    <img
                      src={article.image}
                      alt={article.title}
            ...
            <div className="rounded p-4" style={{ background: "#f8f8f8", border: "1px solid #ebebeb" }}>
              ...
              >
                Torres, E. (2024). La Simetría Oculta de las Redes Neuronales Celulares.
                CienciaEduc, 14(2), 42–62.
              </p>
              <button
      ...
      <section className="max-w-[1200px] mx-auto px-6 pb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          {/* Large dark image card */}
          <Link
            to={`/articulo/${editorialArticles[0].slug}`}
            className="md:col-span-5 group block"
            style={{ textDecoration: "none" }}
          >
            <div
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            {/* Quote card */}
            <div
              className="rounded p-5 flex flex-col justify-center flex-1"
              style={{ background: "#f8f8f8", border: "1px solid #ebebeb", minHeight: "130px" }}
            >
            ...
            {/* Stat card */}
            <div
              className="rounded p-5 flex flex-col justify-center"
              style={{ background: "#0b0b0b", minHeight: "130px" }}
            >
              <p
                style={{
                  fontFamily: "'Playfair Display', serif",
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            <Link
              to={`/articulo/${editorialArticles[2].slug}`}
            ...
            <Link
              to={`/articulo/${editorialArticles[1].slug}`}
              className="block group"
              style={{ textDecoration: "none" }}
            >
              <div
                className="relative rounded overflow-hidden"
                style={{ height: "128px", background: "#111" }}
              >
                <img
                  src={editorialArticles[1].image}
                  alt={editorialArticles[1].title}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                  style={{ opacity: 0.7 }}
                />
                <div
        ...
        {/* Second row: additional articles */}
          ...
          {articles.slice(5, 8).map((article) => (
            ...
            >
              <article className="flex gap-3 py-4" style={{ borderBottom: "1px solid #f0f0f0" }}>
                <div
                  className="flex-shrink-0 rounded overflow-hidden"
                  style={{ width: "72px", height: "58px", background: "#111" }}
                >
                  <img
                    src={article.image}
                    alt={article.title}
          ...
          {feedCategories.map((cat) => (
            <button
              ...
              style={{
                ...
                padding: "5px 14px",
                cursor: "pointer",
                letterSpacing: activeFeedCategory === cat.id ? "0.04em" : "0",
                transition: "all 0.2s",
              }}
            >
              <span style={{ color: activeFeedCategory === cat.id ? "#fff" : "#666" }}>
                {cat.label}
              </span>
            </button>
          ))}
