      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              La comunidad científica hispanohablante te espera. Compartimos investigación
              de excelencia en biología, física, química, astrofísica y metodología
              científica con rigor editorial y acceso abierto.
            </p>
          ...
          {/* Right: editorial process timeline */}
          <div
            style={{
          ...
          >
            ...
            {[
              ...
              <div key={i} className="flex gap-4" style={{ marginBottom: i < 4 ? "20px" : 0 }}>
                {/* Step indicator */}
